  ...
  return (
    <div style={styles.background}>
      ...
      <Section>
        <SectionLeft>
          <Paragraph>
            I know it's a really big move and will be a big transition for you and I want to do everything I can to help make it easier. I don't think I've thought of everything I could do yet (and I'm open to ideas, please) but I want to make sure you have unlimited yoga for the first three months.
          </Paragraph>
          <Paragraph>
